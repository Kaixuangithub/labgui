...
#        print "line created "+msg
    ...
    def remove_lastline(self):
        ...
        box_array=[self.color_btn_list, self.var_name_le_list,self.calculation_le_list]        
...
#            print item
        ...
        self.vertical_layout.addLayout(self.grid)
        spacer_item = QtGui.QSpacerItem(20, 183, QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vertical_layout.addItem(spacer_item)
    ...
    def load_settings(self, fname):
        ...
        try:
            ...
            for line in settings_file:
                ...
                # but commas may also occur in the python line, so only split on the first two
