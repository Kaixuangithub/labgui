...
#        self.verticalLayout.addItem(spacerItem)   
        ...
        self.connect(self.loadFileButton,SIGNAL('clicked()'),self.on_loadFileButton_clicked)
        self.connect(self.plotButton,SIGNAL('clicked()'),self.on_plotButton_clicked)
        self.connect(self.loadFileLineEdit,SIGNAL("textChanged(const QString &)"),self.text_changed)
