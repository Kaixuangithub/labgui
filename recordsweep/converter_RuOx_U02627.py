...
#the function for the calibration can be found in the documentation from Lakeshore Cryogenics
def R_to_T(resistance):
        ...
        if resistance > 1676:      #between 300mK and 2.2K
            ...
            #compute temperature from coefficients above
            temperature = A0*cos(0*acos(k)) + A1*cos(1*acos(k)) + A2*cos(2*acos(k)) + A3*cos(3*acos(k)) + A4*cos(4*acos(k)) + A5*cos(5*acos(k)) + A6*cos(6*acos(k)) + A7*cos(7*acos(k)) + A8*cos(8*acos(k))+ A9*cos(9*acos(k)) + A10*cos(10*acos(k)) 
            #temperature = A0*cos(0*acos(k)) + A1*cos(1*acos(k)) + A2*cos(2*acos(k)) + A3*cos(3*acos(k)) + A4*cos(4*acos(k)) + A5*cos(5*acos(k)) + A6*cos(6*acos(k)) + A7*cos(7*acos(k)) + A8*cos(8*acos(k))  
            ...
            #compute temperature from coefficients above
            temperature = A0*cos(0*acos(k)) + A1*cos(1*acos(k)) + A2*cos(2*acos(k)) + A3*cos(3*acos(k)) + A4*cos(4*acos(k)) + A5*cos(5*acos(k)) + A6*cos(6*acos(k)) + A7*cos(7*acos(k)) + A8*cos(8*acos(k))+A9*cos(9*acos(k))   
